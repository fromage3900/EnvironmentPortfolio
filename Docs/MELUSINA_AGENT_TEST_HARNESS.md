...
> ## STALE DUPLICATE — DO NOT SEND, DO NOT CITE
>
> **This file is a stale copy from 2026-08-18.** The maintained version is
> [`../BS_GodFile/Docs/MELUSINA_AGENT_TEST_HARNESS.md`](../BS_GodFile/Docs/MELUSINA_AGENT_TEST_HARNESS.md).
>
> **Why this matters:** on 2026-08-19 the unpublished 100-task / 98.8% TCA model scores were
> **withdrawn** in the maintained copy. This copy predates that correction and still presents
> those figures as measured benchmark results, addressed to a named research organization.
> They were never measured. The only evaluation artifact in this repository is
> `eval_results.json`: one model, one task, 60.35%, 0% pass rate.
>
> Nothing in this file may be sent, published, or cited. Read the maintained copy instead.
>
> Retained only so that any existing link resolves to this warning rather than to the
> uncorrected numbers.
