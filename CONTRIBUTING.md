...
2. **Environment & Level Designers:** Follow [Docs/SETUP_COLLAB.md](BS_GodFile/Docs/SETUP_COLLAB.md) for lightweight sparse checkout.
3. **Engineers & Researchers:** Clone the repository and pull Git LFS tracked assets (`git lfs pull`).
4. Execute `BS_GodFile/deploy/validate_setup.ps1` (or `python BS_GodFile/Tools/test_melodia_mcp.py`) to verify your local environment health.
...
3. **Validate:** Run test suites locally (`python BS_GodFile/Tools/test_melodia_mcp.py` and workspace validators).
...
- Complete Documentation Index: [DOC_INDEX.md](BS_GodFile/DOC_INDEX.md)
- Agent Test Harness Whitepaper: [Docs/MELUSINA_AGENT_TEST_HARNESS.md](BS_GodFile/Docs/MELUSINA_AGENT_TEST_HARNESS.md)
- LLM Daemon Ecosystem Report: [Docs/OLLAMA_UE5_INTEGRATION_REPORT.md](BS_GodFile/Docs/OLLAMA_UE5_INTEGRATION_REPORT.md)
- Live Collaboration Setup: [Docs/SETUP_COLLAB.md](BS_GodFile/Docs/SETUP_COLLAB.md)
